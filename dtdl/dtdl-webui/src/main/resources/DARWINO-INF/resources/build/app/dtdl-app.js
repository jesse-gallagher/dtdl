...
class DTDLApp {
    render() {
        return (h("div", null,
            h("nav", { class: "navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow" },
                h("stencil-route-link", { url: '/', class: "navbar-brand col-sm-3 col-md-2 mr-0" }, "Darwino To-Do List")),
            h("div", { class: "container-fluid" },
                h("div", { class: "row" },
                    h("nav", { class: "col-md-2 d-none d-md-block bg-light sidebar" },
                        h("div", { class: "sidebar-sticky" },
                            h("ul", { class: "nav flex-column" },
                                h("li", { class: "nav-item" },
                                    h("stencil-route-link", { url: '/', class: "nav-link" }, "Home")),
                                h("li", { class: "nav-item" },
                                    h("stencil-route-link", { url: '/profile/foo', class: "nav-link" }, "Profile")))))),
                h("main", { role: "main", class: "col-md-9 ml-sm-auto col-lg-10 px-4" },
...
export { DTDLApp as DtdlApp, Route as StencilRoute, Router as StencilRouter };
