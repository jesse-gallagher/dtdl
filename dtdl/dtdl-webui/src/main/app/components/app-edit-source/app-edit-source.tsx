...
export class AppEditSource {
    ...
    handleFieldChange(prop: string, e) {
        const newObj = { ...this.source };
        lodash.set(newObj, prop, e.target.value);
        this.source = newObj;
    }
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gitHubToken" value={this.source.github.token}
                            onInput={(e) => this.handleFieldChange('github.token', e)}
                            onChange={(e) => this.handleFieldChange('github.token', e)} />
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gitHubRepository" value={this.source.github.repository}
                            onInput={(e) => this.handleFieldChange('github.repository', e)}
                            onChange={(e) => this.handleFieldChange('github.repository', e)} />
                    </div>
                </fieldset>
            );
        case "BITBUCKET":
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bitbucketUsername" value={this.source.bitbucket.username}
                            onInput={(e) => this.handleFieldChange('bitbucket.username', e)}
                            onChange={(e) => this.handleFieldChange('bitbucket.username', e)} />
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bitbucketPassword" value={this.source.bitbucket.password}
                            onInput={(e) => this.handleFieldChange('bitbucket.password', e)}
                            onChange={(e) => this.handleFieldChange('bitbucket.password', e)} />
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bitbucketRepository" value={this.source.bitbucket.repository}
                            onInput={(e) => this.handleFieldChange('bitbucket.repository', e)}
                            onChange={(e) => this.handleFieldChange('bitbucket.repository', e)} />
                    </div>
                </fieldset>
            );
        default:
